...
static struct gk_option long_options[] = {
  {(char*)"ctype",          1,      0,      METIS_OPTION_CTYPE},
  {(char*)"iptype",         1,      0,      METIS_OPTION_IPTYPE},
  {(char*)"rtype",          1,      0,      METIS_OPTION_RTYPE}, 
  {(char*)"ufactor",        1,      0,      METIS_OPTION_UFACTOR},
  {(char*)"pfactor",        1,      0,      METIS_OPTION_PFACTOR},
  {(char*)"nocompress",     0,      0,      METIS_OPTION_COMPRESS},
  {(char*)"ccorder",        0,      0,      METIS_OPTION_CCORDER},
  {(char*)"nooutput",       0,      0,      METIS_OPTION_NOOUTPUT},
  {(char*)"niter",          1,      0,      METIS_OPTION_NITER},
  {(char*)"nseps",          1,      0,      METIS_OPTION_NSEPS},
  {(char*)"seed",           1,      0,      METIS_OPTION_SEED},
  {(char*)"dbglvl",         1,      0,      METIS_OPTION_DBGLVL},
  {(char*)"help",           0,      0,      METIS_OPTION_HELP},
  {0,                0,      0,      0}
};


static gk_StringMap_t ctype_options[] = {
 {(char*)"rm",                 METIS_CTYPE_RM},
 {(char*)"shem",               METIS_CTYPE_SHEM},
 {NULL,                 0}
};

static gk_StringMap_t iptype_options[] = {
 {(char*)"edge",               METIS_IPTYPE_EDGE},
 {(char*)"node",               METIS_IPTYPE_NODE},
 {NULL,                 0}
};

static gk_StringMap_t rtype_options[] = {
 {(char*)"2sided",             METIS_RTYPE_SEP2SIDED},
 {(char*)"1sided",             METIS_RTYPE_SEP1SIDED},
 {NULL,                 0}
};
...
params_t *parse_cmdline(int argc, char *argv[])
{
  ...
  params = (params_t *)gk_malloc(sizeof(params_t), (char*)"parse_cmdline");
  ...
  while ((c = gk_getopt_long_only(argc, argv, (char*)"", long_options, &option_index)) != -1) {
    switch (c) {
      ...
      case '?':
      default:
        errexit((char*)"Illegal command-line option(s)\n"
