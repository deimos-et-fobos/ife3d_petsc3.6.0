      subroutine desplazamientofluido_vtk_case(nevs)
      ...
      WorkDir = 'Sol/Fluido/'
      filename = trim(WorkDir) // 'desplazamiento_fluido.case'
      open(27,file=filename)
      write(27,'(a)')  'FORMAT'        
      write(27,'(a)')  'type:   ensight'        
      write(27,'(a)')  ''        
      write(27,'(a)')  'GEOMETRY'        
      write(27,'(a)')  'model:     errores.geo'        
      write(27,'(a)')  ''        
      write(27,'(a)')  'VARIABLE'        
      write(27,'(a)')  ''        
      write(27,'(2a)')  'vector per node:     Desplazamiento    ',
     &                  'desplazamiento_fluido-****.vec' 
      write(27,'(2a)')  'scalar per node:     ',
     &                  'Divergencia    divergencia-****.scl' 
      write(27,'(a)')  ''        
      write(27,'(a)')  'TIME'        
