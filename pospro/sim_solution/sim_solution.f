...
*
 ...
 11   StNfile = Str4(Nfile)
      ...
      FileOut=trim(WorkDir)//'PV-sim-'//StNfield//'-'//StNfile//'.vec'
...
*
 ...
 30   StNfile = Str4(Nfile)
      ...
      FileOut=trim(WorkDir)//'desplazamiento-sim-'//StNfile//'.vec'
      open(1,file=FileIn,access='DIRECT',recl=4,
...
*
 ...
 130  StNfile = Str4(Nfile)
      ...
      FileOut=trim(WorkDir)//'presion-sim-'//StNfile//'.scl'
      open(1,file=FileIn,access='DIRECT',recl=4,
...
*
 ...
 330  StNfile = Str4(Nfile)
      ...
      FileOut=trim(WorkDir)//'error-sim-'//StNfile//'.scl'
      open(1,file=FileIn,access='DIRECT',recl=4,
...
*
 ...
 430  StNfile = Str4(Nfile)
      ...
      FileOut=trim(WorkDir)//'pconf-sim-'//StNfile//'.scl'
      open(1,file=FileIn,access='DIRECT',recl=4,
