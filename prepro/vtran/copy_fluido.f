      ...
      subroutine copy_fluido(mm,mmsur,z,ncopy,dx,dy,dz)
...
!     Escritura de archivos nuevos
      ...
      do 1000 k=0,ncopy-1 
        do 1100 i=1,nver
          write(14,*) k*nver+i,z(1,i)+k*dx,z(2,i)+k*dy,z(3,i)+k*dz
          write(15,*) k*nver+i,z(1,i)+k*dx,z(2,i)+k*dy,z(3,i)+k*dz
 1100   continue
 1000 continue
...
!      do 2000 k=0,ncopy-1
!        do 2100 i=1,el_ngrs
!          write(14,123) k*el_ngrs+i,el_gr(i),'Tetra4'
! 2100   continue
! 2000 continue
      i=1
      write(14,123) i,nel*k,'Tetra4'
 ...
 3000 continue
      ...
      do 4000 k=0,ncopy-1
        do 4100 i=1,sur_ngrs
          write(15,123) k*sur_ngrs+i,sur_gr(i),'Tri3  '
 4100   continue
 4000 continue
