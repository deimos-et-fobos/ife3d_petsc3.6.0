      ...
      subroutine move_placa(mm,mmsur,z,dx,dy)
...
!     Escritura de archivos nuevos
      ...
      write(15,*) nver
      do 1000 i=1,nver
        write(14,*) i,z(1,i)+dx,z(2,i)+dy
        write(15,*) i,z(1,i)+dx,z(2,i)+dy
 1000 continue
