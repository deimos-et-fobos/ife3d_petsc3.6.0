...
*/
  ...
  xlnz   = imalloc(nvtxs+2, (char*)"ComputeFillIn: xlnz");
  xnzsub = imalloc(nvtxs+2, (char*)"ComputeFillIn: xnzsub");
  nzsub  = imalloc(maxsub+1, (char*)"ComputeFillIn: nzsub");
               ...
               idx_t *maxsub)
{
  ...
  rchlnk = ismalloc(neqns+1, 0, (char*)"smbfct: rchlnk");
  marker = ismalloc(neqns+1, 0, (char*)"smbfct: marker");
  mrglnk = ismalloc(neqns+1, 0, (char*)"smbfct: mgrlnk");
